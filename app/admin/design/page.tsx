      ...
      <section className="adminHero compactAdminHero visualAdminHero">
        <div className="container adminHeroInner">
          <div>
            ...
            <p>Hero Builder 2.0 объединяет Hero всех основных страниц в одну систему слоёв: выбирай объект прямо в preview, скрывай, блокируй и меняй порядок. Image Editor 2.0 и Canvas 2.0 сохраняют независимые Desktop/Tablet/Mobile настройки.</p>
          </div>
