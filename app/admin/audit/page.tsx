...
const fieldLabels: Record<string, string> = {
  ...
  design_config: "Настройки дизайна блока",
  ...
  page_key: "Страница / шаблон",
  background_mode: "Источник фона",
  desktop_image_url: "Фото Desktop",
  mobile_image_url: "Фото Mobile",
  desktop_position_x: "Фокус Desktop X",
  desktop_position_y: "Фокус Desktop Y",
  desktop_zoom_percent: "Масштаб Desktop",
  mobile_position_x: "Фокус Mobile X",
  mobile_position_y: "Фокус Mobile Y",
  mobile_zoom_percent: "Масштаб Mobile",
  hero_height_desktop: "Высота Desktop",
  hero_height_mobile: "Высота Mobile",
  overlay_style: "Тип затемнения",
  text_alignment: "Выравнивание текста",
  content_width: "Ширина текста",
  show_eyebrow: "Показывать eyebrow",
