    ...
    <main className="adminPage">
      <section className="adminHero compactAdminHero">
        <div className="container adminHeroInner">
          <div>
            <p className="eyebrow">FC EDINEȚ • КЛУБ</p>
            <h1>Раздел клуба</h1>
            <p>История, стадион, контакты, руководство и достижения.</p>
          </div>
          ...
          <div className="adminHeroActions">
            ...
            <Link href="/club" className="rowAction muted">
              Открыть на сайте ↗
            </Link>
          </div>
        </div>
      ...
      <section className="section adminSurface">
        <div className="container">
          ...
          <div className="clubAdminTwoColumns">
            <ClubLeadershipAdmin />
            <ClubAchievementAdmin />
          </div>
          ...
          <section className="clubAdminListSection">
            ...
            {leaders.length > 0 ? (
              <div className="clubAdminItems">
                {leaders.map((leader) => (
                  <article className="clubAdminItem" key={leader.id}>
                    <div className="clubAdminItemImage">
                      {leader.photo_url ? (
                    ...
                    <div className="clubAdminItemMain">
                    ...
                    <form action={updateLeader} className="clubInlineControls">
                      ...
                      <input
                        ...
                        type="number"
                        min={0}
                        defaultValue={leader.display_order}
                      />
                      <label>
                        <input
                          type="checkbox"
                          name="is_active"
                          defaultChecked={leader.is_active}
                        />
                        На сайте
                      </label>
            ...
            {achievements.length > 0 ? (
              <div className="clubAdminItems">
                {achievements.map((item) => (
                  <article
                    className="clubAdminItem achievement"
                    key={item.id}
                  >
                    <div className="clubAchievementYear">
                      {item.year || "—"}
                    </div>
